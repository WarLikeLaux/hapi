export default {
  ...
  'newSession.termdeck.title': 'TermDeck 终端',
  'newSession.termdeck.desc': '创建连接到此 HAPI 会话的桌面终端。',
  'termdeck.linkFailed': '会话已启动，但 TermDeck 未启动',
  'termdeck.openFailed': '无法打开 TermDeck',
