export default {
  ...
  'nav.chats': '聊天',
  'chats.title': '聊天',
  'chats.manage': '连接并选择聊天',
  'chats.close': '关闭',
  'chats.empty.title': '添加 Telegram 聊天',
  'chats.empty.hint': '连接账号，并仅选择要在这里显示的会话。',
  'chats.pickConversation': '从聊天列表中选择一个会话。',
  ...
  'chats.names.hint': '这些名称仅保存在 HAPI 中。留空则使用 Telegram 名称。',
  'chats.names.chatPlaceholder': '添加本地名称',
  'chats.names.people': '此聊天中的成员',
  'chats.names.personPlaceholder': '添加本地名称',
  'chats.names.loadingPeople': '正在加载已缓存的成员…',
  'chats.saveSelection': '保存所选聊天',
  'chats.saving': '保存中…',
  'chats.connectTelegram': '连接 Telegram',
  'chats.connecting': '连接中…',
  'chats.continue': '继续',
  'chats.telegram.credentialsHint': '使用 my.telegram.org 的 API ID 和 Hash。它们只保存在此 HAPI Hub 上。',
  'chats.telegram.phone': '手机号码',
  'chats.telegram.code': '登录验证码',
  'chats.telegram.password': '两步验证密码',
  'chats.connection.unconfigured': '未连接',
  'chats.connection.starting': '正在连接 Telegram…',
  'chats.connection.awaiting_phone': '等待手机号码',
  'chats.connection.awaiting_code': '等待登录验证码',
  'chats.connection.awaiting_password': '等待密码',
  'chats.connection.ready': '已连接',
  'chats.connection.error': '连接错误',
  'chats.connection.unavailable': '连接器不可用',
  'sessions.new': '新建会话',
  ...
  'sessions.search.tabChats': '聊天',
  'sessions.search.tabMessages': '消息',
  'sessions.messageSearch.title': '聊天中的消息',
  'sessions.messageSearch.roleUser': '你',
  'sessions.messageSearch.roleAgent': 'Agent',
  'sessions.messageSearch.failed': '消息搜索失败',
  'sessions.messageSearch.empty': '没有匹配的消息',
  'sessions.messageSearch.moreInSession': '此聊天中还有 {n} 条',
  'sessions.messageSearch.showInSession': '查看此聊天中的 {n} 条',
  'sessions.messageSearch.loadMore': '加载更多',
  ...
  'sessions.recentSection': '最近会话',
  'sessions.recentToggle': '展开或收起最近会话',
  'sessions.group.new': '在此目录新建会话',
  'sessions.project.deleteAll': '删除全部会话',
  'sessions.project.deleteTitle': '删除项目会话？',
  'sessions.project.deleteDescription': '删除“{name}”中的 {count} 个 HAPI 会话？正在运行的会话将停止。本地 Agent 对话记录会保留，之后仍可重新同步。',
  'sessions.project.deleteConfirm': '全部删除',
  'sessions.project.deleting': '删除中…',
  'sessions.machineFilter.label': '按机器筛选会话',
  'sessions.machineFilter.all': '全部',
  'sessions.context.tabsLabel': '按上下文筛选会话',
  'sessions.context.all': '全部',
  'sessions.context.work': '工作',
  'sessions.context.lab': '实验室',
  'sessions.context.chill': '日常',
  'sessions.context.setLabel': '分组',
  'sessions.context.none': '无',
  'sessions.context.auto': '自动',
  ...
  'session.responseChanges.open': '查看更改',
  'session.responseChanges.title': '此步骤中的更改',
  'session.responseChanges.files': '文件：{n}',
  'session.responseChanges.tooLarge': '差异过大，无法显示，但仍可查看摘要。',
  'diff.file.collapse': '隐藏 {path} 中的更改',
  'diff.file.expand': '显示 {path} 中的更改',
  ...
  'session.action.startDifit': '启动 DIFIT',
  'session.action.restartDifit': '重启 DIFIT',
  'session.action.startDifitDone': 'DIFIT 已启动',
  'session.action.restartDifitDone': 'DIFIT 已重启',
  'session.action.difitDoneBody': '评审已就绪。',
  ...
  'dialog.restart.description': '重启“{name}”？当前进程会先停止，然后使用最新的 runner 重新打开同一对话。',
  'dialog.restart.confirm': '重启会话',
  'dialog.restart.confirming': '正在重启…',
  ...
  'files.page.searchChangesPlaceholder': '搜索已更改的文件',
  'files.page.searchProjectPlaceholder': '搜索项目文件',
  'files.projectRoot': '项目根目录',
  'files.branch.detached': '游离 HEAD',
  'files.branch.summary': '{staged} 个已暂存，{unstaged} 个未暂存',
  'files.comparison.label': '要显示的变更',
  'files.comparison.working': '工作区',
  'files.comparison.lastCommit': '最近一次提交',
  'files.comparison.branch': '分支变更',
  'files.comparison.defaultBranch': '默认分支',
  'files.comparison.lastCommitSummary': '{sha} {subject}',
  'files.comparison.branchSummary.one': '相对 {base} 有 1 个提交',
  'files.comparison.branchSummary.other': '相对 {base} 有 {n} 个提交',
  'files.comparison.empty.lastCommit': '最近一次提交没有文件变更。',
  'files.comparison.empty.branch': '相对 {base} 没有已提交的变更。',
  'files.comparison.error': 'Git 比较不可用：{error}',
  'files.tab.changes': '变更',
  'files.tab.directories': '目录',
  'files.search.empty': '没有匹配搜索的文件。',
  'files.search.changesEmpty': '没有匹配搜索的已更改文件。',
  ...
  'files.display.label': '变更显示方式',
  'files.display.files': '文件',
  'files.display.fullDiff': '完整差异',
  'files.fullDiff.loading': '正在加载完整差异…',
  'files.fullDiff.error': '无法加载完整差异。',
  'files.fullDiff.empty': '没有可显示的差异。',
  ...
  'settings.general.agentBranding.title': '智能体品牌显示',
  'settings.general.agentBranding.description': '控制应用中各智能体类型的名称与标志显示方式。',
  'settings.general.brandClaudeAsGlm': '以 GLM（z.ai）代替 Claude 显示',
  'settings.general.brandClaudeAsGlm.desc': '适用于通过 z.ai 接入 GLM 模型的 Claude Code 场景。开启后，claude 类型的会话将在应用和通知中显示为 GLM 并使用 z.ai 标志。仅影响显示，不会改变实际运行的 CLI。',
  ...
  'settings.display.workAliases': '工作上下文关键字',
  'settings.display.workAliases.desc': '默认归类为“工作”的目录名或别名（以逗号分隔，手动标签优先）',
  'settings.display.workAliases.placeholder': '例如：corp, client, project',
  ...
  'settings.display.sessionHeader.branch': 'Git 分支',
  ...
  'settings.limits.title': '智能体限额',
  'settings.limits.summary': '智能体订阅限额用量',
  'settings.limits.description': '由各设备上的 Runner 上报的订阅限额。Runner 连接期间每隔几分钟刷新一次。',
  'settings.limits.loading': '正在加载限额…',
  ...
  'settings.limits.inMinutes': '{minutes} 分钟后',
  'settings.limits.inHours': '{hours} 小时后',
  'settings.limits.inHoursMinutes': '{hours} 小时 {minutes} 分钟后',
  'settings.limits.inDay': '1 天后',
  'settings.limits.inDays': '{days} 天后',
  'settings.limits.inDaysHours': '{days} 天 {hours} 小时后',
  'settings.limits.stale': '{ago}前测量',
  'settings.limits.ageMinutes': '{minutes} 分钟',
  'settings.limits.ageHours': '{hours} 小时',
  'settings.limits.offline': 'Runner 离线',
  'settings.limits.unavailable.auth_expired': '认证已过期',
  'settings.limits.unavailable.unavailable': '不可用',
  ...
  'settings.limits.weekdays.tuesday': '星期二',
  'settings.limits.weekdays.wednesday': '星期三',
  'settings.limits.weekdays.thursday': '星期四',
  'settings.limits.weekdays.friday': '星期五',
  'settings.limits.weekdays.saturday': '星期六',
  ...
  'browse.searchPlaceholder': '搜索项目…',
  'browse.pinProject': '固定项目',
  'browse.unpinProject': '取消固定项目',
