export default {
  ...
  'nav.chats': 'Chats',
  'chats.title': 'Chats',
  'chats.manage': 'Connect and choose chats',
  'chats.close': 'Close',
  'chats.empty.title': 'Add a Telegram chat',
  'chats.empty.hint': 'Connect your account and choose only the conversations you want here.',
  'chats.pickConversation': 'Choose a conversation from the chat list.',
  ...
  'chats.names.hint': 'These names are stored only in HAPI. Leave a field empty to use the Telegram name.',
  'chats.names.chatPlaceholder': 'Add local name',
  'chats.names.people': 'People in this chat',
  'chats.names.personPlaceholder': 'Add local name',
  'chats.names.loadingPeople': 'Loading cached people…',
  'chats.saveSelection': 'Save selected chats',
  'chats.saving': 'Saving…',
  'chats.connectTelegram': 'Connect Telegram',
  'chats.connecting': 'Connecting…',
  'chats.continue': 'Continue',
  'chats.telegram.credentialsHint': 'Use the API ID and hash from my.telegram.org. They are stored only on this HAPI hub.',
  'chats.telegram.phone': 'Phone number',
  'chats.telegram.code': 'Login code',
  'chats.telegram.password': 'Two-step verification password',
  'chats.connection.unconfigured': 'Not connected',
  'chats.connection.starting': 'Connecting to Telegram…',
  'chats.connection.awaiting_phone': 'Waiting for phone number',
  'chats.connection.awaiting_code': 'Waiting for login code',
  'chats.connection.awaiting_password': 'Waiting for password',
  'chats.connection.ready': 'Connected',
  'chats.connection.error': 'Connection error',
  'chats.connection.unavailable': 'Connector unavailable',
  ...
  'sessions.search.tabChats': 'Chats',
  'sessions.search.tabMessages': 'Messages',
  'sessions.messageSearch.title': 'Messages in chats',
  'sessions.messageSearch.roleUser': 'You',
  'sessions.messageSearch.roleAgent': 'Agent',
  'sessions.messageSearch.failed': 'Message search failed',
  'sessions.messageSearch.empty': 'No matching messages',
  'sessions.messageSearch.moreInSession': '+{n} more in this chat',
  'sessions.messageSearch.showInSession': 'Show {n} in this chat',
  'sessions.messageSearch.loadMore': 'Load more',
  ...
  'sessions.recentSection': 'Recent sessions',
  'sessions.recentToggle': 'Toggle recent history',
  'sessions.group.new': 'New session in this directory',
  'sessions.project.deleteAll': 'Delete all sessions',
  'sessions.project.deleteTitle': 'Delete project sessions?',
  'sessions.project.deleteDescription': 'Delete all HAPI sessions from “{name}”? Sessions to delete: {count}. Active sessions will be stopped. Local agent transcripts are kept and can be synced again.',
  'sessions.project.deleteConfirm': 'Delete all',
  'sessions.project.deleting': 'Deleting…',
  'sessions.machineFilter.label': 'Filter sessions by machine',
  'sessions.machineFilter.all': 'All',
  'sessions.context.tabsLabel': 'Filter sessions by context',
  'sessions.context.all': 'All',
  'sessions.context.work': 'Work',
  'sessions.context.lab': 'Lab',
  'sessions.context.chill': 'Chill',
  'sessions.context.setLabel': 'Context',
  'sessions.context.none': 'None',
  'sessions.context.auto': 'Auto',
  ...
  'session.action.openExternalReview': 'Open PR',
  'session.action.createExternalReview': 'Create PR',
  'session.action.startDifit': 'Start DIFIT',
  'session.action.restartDifit': 'Restart DIFIT',
  'session.action.startDifitDone': 'DIFIT started',
  'session.action.restartDifitDone': 'DIFIT restarted',
  'session.action.difitDoneBody': 'The review is ready.',
  ...
  'session.responseChanges.title': 'Changes in this step',
  'session.responseChanges.files': 'Files: {n}',
  'session.responseChanges.tooLarge': 'The diff is too large to display, but its summary is still available.',
  'diff.file.collapse': 'Hide changes in {path}',
  'diff.file.expand': 'Show changes in {path}',
  'session.action.archive': 'Stop session',
  'session.action.reopen': 'Reopen',
  'session.action.restart': 'Restart session',
  ...
  'dialog.archive.title': 'Stop Session',
  'dialog.archive.description': 'Stop "{name}"? The conversation will be saved and can be reopened later.',
  'dialog.archive.confirm': 'Stop session',
  'dialog.archive.confirming': 'Stopping…',
  'dialog.restart.title': 'Restart session?',
  'dialog.restart.description': 'Restart “{name}”? The current process will stop, then the same conversation will reopen on the latest runner.',
  'dialog.restart.confirm': 'Restart session',
  ...
  'files.page.searchChangesPlaceholder': 'Search changed files',
  'files.page.searchProjectPlaceholder': 'Search project files',
  'files.projectRoot': 'project root',
  'files.branch.detached': 'detached HEAD',
  'files.branch.summary': '{staged} staged, {unstaged} unstaged',
  'files.comparison.label': 'Changes to show',
  'files.comparison.working': 'Working tree',
  'files.comparison.lastCommit': 'Last commit',
  'files.comparison.branch': 'Branch changes',
  'files.comparison.defaultBranch': 'default branch',
  'files.comparison.lastCommitSummary': '{sha} {subject}',
  'files.comparison.branchSummary.one': '1 commit vs {base}',
  'files.comparison.branchSummary.other': '{n} commits vs {base}',
  'files.comparison.empty.lastCommit': 'The last commit has no file changes.',
  'files.comparison.empty.branch': 'No committed changes from {base}.',
  'files.comparison.error': 'Git comparison unavailable: {error}',
  'files.tab.changes': 'Changes',
  'files.tab.directories': 'Directories',
  'files.search.empty': 'No files match your search.',
  'files.search.changesEmpty': 'No changed files match your search.',
  ...
  'files.display.label': 'Changes display',
  'files.display.files': 'Files',
  'files.display.fullDiff': 'Full diff',
  'files.fullDiff.loading': 'Loading full diff…',
  'files.fullDiff.error': 'Could not load the full diff.',
  'files.fullDiff.empty': 'No diff to display.',
  ...
  'settings.general.agentBranding.title': 'Agent branding',
  'settings.general.agentBranding.description': 'How agent flavors are named and marked in this app.',
  'settings.general.brandClaudeAsGlm': 'Show GLM (z.ai) instead of Claude',
  'settings.general.brandClaudeAsGlm.desc': 'For Claude Code setups wired to GLM models via z.ai. When on, claude-flavor sessions are labeled GLM with the z.ai mark across the app and in notifications. Purely cosmetic - it does not change which CLI runs.',
  ...
  'settings.display.workAliases': 'Work context keywords',
  'settings.display.workAliases.desc': 'Comma-separated directory names or aliases classified as Work by default (overridden by manual tags)',
  'settings.display.workAliases.placeholder': 'e.g. corp, client, project',
  ...
  'settings.display.sessionHeader.branch': 'Git branch',
  ...
  'settings.limits.title': 'Agent limits',
  'settings.limits.summary': 'Subscription limit usage for your agents',
  'settings.limits.description': 'Subscription limits reported by runners on each machine. Usage is refreshed every few minutes while a runner is connected.',
  'settings.limits.loading': 'Loading limits…',
  ...
  'settings.limits.stale': 'measured {ago} ago',
  'settings.limits.ageMinutes': '{minutes}m',
  'settings.limits.ageHours': '{hours}h',
  'settings.limits.offline': 'Runner offline',
  'settings.limits.unavailable.auth_expired': 'Authentication expired',
  'settings.limits.unavailable.unavailable': 'Unavailable',
  'settings.limits.source.zai': 'GLM (Z.AI)',
  ...
  'settings.limits.weekdays.tuesday': 'вторник',
  'settings.limits.weekdays.wednesday': 'среда',
  'settings.limits.weekdays.thursday': 'четверг',
  'settings.limits.weekdays.friday': 'пятница',
  'settings.limits.weekdays.saturday': 'суббота',
  ...
  'browse.searchPlaceholder': 'Search projects…',
  'browse.pinProject': 'Pin project',
  'browse.unpinProject': 'Unpin project',
