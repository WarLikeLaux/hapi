export default {
  ...
  'newSession.termdeck.title': 'TermDeck terminal',
  'newSession.termdeck.desc': 'Create a desktop terminal attached to this HAPI session.',
  'termdeck.linkFailed': 'Session started, but TermDeck did not',
  'termdeck.openFailed': 'Could not open TermDeck',
