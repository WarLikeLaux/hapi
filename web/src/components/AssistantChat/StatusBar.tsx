...
export const WORKING_STATUS_MESSAGES = [
    'ебусь с этой штукой', 'разъёбываю задачу по частям', 'ищу, где насрали',
    'делаю, чтобы не было стыдно', 'проверяю, не пиздит ли код',
    'читаю логи как улики', 'вычисляю главного подозреваемого',
    'пинаю тесты до зелёного', 'раскапываю древнее говно',
    'свожу этот бардак воедино', 'душу баг фактами', 'торгуюсь с компилятором',
    'делаю вид, что всё под контролем', 'нашёл ниточку, тяну',
    'копаю туда, где страшно', 'собираю фикс без магии',
    'проверяю алиби у каждой строчки', 'убираю технический пиздец',
    'проверяю, не отъебнулось ли ещё что-то', 'делаю 67 умных движений',
    'сикс севен, почти готово', 'переставляю байты местами',
    'убеждаю код не выёбываться', 'чиню то, что само не починилось',
    'ищу смысл в чужом легаси', 'докручиваю, пока не заебись',
    'собираю костыли в несущую конструкцию', 'проверяю план на пиздёж',
    'стучу по коду диагностическим молотком', 'ещё немного страдаю'
]

export const READY_STATUS_MESSAGES = [
    'готов ебашить', 'жив, цел, на связи', 'стою заряженный',
    'можно наваливать', 'всё, я свободен', 'готов к следующей хуйне',
    'сижу без дела, непорядок', 'заряжен и подозрительно бодр',
    'жду, чем меня озадачат', 'готов снова лезть в код',
    'на месте, не потерялся', 'сикс севен, я готов'
]
