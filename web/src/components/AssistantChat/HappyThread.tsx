...
export function HappyThread(props: {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            // assistant-ui 0.15 may commit its external runtime one tick after
            // the message-window snapshot. Ignore scroll events against that
            // stale DOM; the layout effect below restores the captured anchor
