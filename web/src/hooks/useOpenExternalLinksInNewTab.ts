...
// The fork has historically protected chat navigation by opening links in a
// separate tab. Keep that default while allowing an explicit opt-out for
// external HTTP(S) links.
export const DEFAULT_OPEN_EXTERNAL_LINKS_IN_NEW_TAB = true
