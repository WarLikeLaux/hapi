...
describe('useOpenExternalLinksInNewTab helpers', () => {
    ...
    it('defaults to the fork-safe new-tab behavior', () => {
...
describe('useOpenExternalLinksInNewTab', () => {
    ...
    it('persists changes and synchronizes hook instances in the same tab', () => {
        ...
        act(() => first.result.current.setOpenExternalLinksInNewTab(false))
        ...
        act(() => second.result.current.setOpenExternalLinksInNewTab(true))
